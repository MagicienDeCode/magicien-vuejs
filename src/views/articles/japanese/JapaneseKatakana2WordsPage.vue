...
useHead({
  title: 'カタカナ単語2 - MagicienDeCode',
  meta: [
    { name: 'description', content: 'Japanese Katakana Words 2 with translations' },
  ],
})
...
onMounted(async () => {
  try {
    const response = await fetch('/data/japanese/words/katakana2.csv')
...
const playNextAudio = () => {
  ...
  const audioPath = `/data/japanese/words/downloads/katakana2/${word.katakana}.mp3`
  ...
  <div class="katakana-words-page">
    <div class="header-row">
      <a-breadcrumb separator=">" class="breads">
        ...
        <a-breadcrumb-item>カタカナ単語2</a-breadcrumb-item>
      </a-breadcrumb>
    ...
    <div class="page-content">
      <h1>カタカナ単語2</h1>
      <p class="subtitle">Katakana Vocabulary 2</p>
