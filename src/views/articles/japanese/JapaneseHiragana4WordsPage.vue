...
useHead({
  title: 'ひらがな単語4 - MagicienDeCode',
  meta: [
    { name: 'description', content: 'Japanese Hiragana Words 4 with translations' },
  ],
})
...
onMounted(async () => {
  try {
    const response = await fetch('/data/japanese/words/hiragana4.csv')
...
const playNextAudio = () => {
  ...
  const audioPath = `/data/japanese/words/downloads/hiragana4/${word.word}.mp3`
  ...
  <div class="hiragana-words-page">
    <div class="header-row">
      <a-breadcrumb separator=">" class="breads">
        ...
        <a-breadcrumb-item>ひらがな単語4</a-breadcrumb-item>
      </a-breadcrumb>
    ...
    <div class="page-content">
      <h1>ひらがな単語4</h1>
      <p class="subtitle">Hiragana Vocabulary 4</p>
